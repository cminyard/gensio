...
%constant int GENSIO_LINESTATE_DATA_READY = GENSIO_LINESTATE_DATA_READY;
%constant int GENSIO_LINESTATE_OVERRUN_ERR = GENSIO_LINESTATE_OVERRUN_ERR;
%constant int GENSIO_LINESTATE_PARITY_ERR = GENSIO_LINESTATE_PARITY_ERR;
%constant int GENSIO_LINESTATE_FRAMING_ERR = GENSIO_LINESTATE_FRAMING_ERR;
%constant int GENSIO_LINESTATE_BREAK = GENSIO_LINESTATE_BREAK;
%constant int GENSIO_LINESTATE_XMIT_HOLD_EMPTY = GENSIO_LINESTATE_XMIT_HOLD_EMPTY;
%constant int GENSIO_LINESTATE_XMIT_SHIFT_EMPTY = GENSIO_LINESTATE_XMIT_SHIFT_EMPTY;
%constant int GENSIO_LINESTATE_TIMEOUT_ERR = GENSIO_LINESTATE_TIMEOUT_ERR;

%constant int GENSIO_MODEMSTATE_CTS_CHANGED = GENSIO_MODEMSTATE_CTS_CHANGED;
%constant int GENSIO_MODEMSTATE_DSR_CHANGED = GENSIO_MODEMSTATE_DSR_CHANGED;
%constant int GENSIO_MODEMSTATE_RI_CHANGED = GENSIO_MODEMSTATE_RI_CHANGED;
%constant int GENSIO_MODEMSTATE_CD_CHANGED = GENSIO_MODEMSTATE_CD_CHANGED;
%constant int GENSIO_MODEMSTATE_CTS = GENSIO_MODEMSTATE_CTS;
%constant int GENSIO_MODEMSTATE_DSR = GENSIO_MODEMSTATE_DSR;
%constant int GENSIO_MODEMSTATE_RI = GENSIO_MODEMSTATE_RI;
%constant int GENSIO_MODEMSTATE_CD = GENSIO_MODEMSTATE_CD;
