...
static struct sound_format_names sound_format_names[] = {
    { "double",		GENSIO_SOUND_FMT_DOUBLE },
    { "float",		GENSIO_SOUND_FMT_FLOAT },
    { "int32",		GENSIO_SOUND_FMT_S32 },
    { "int24",		GENSIO_SOUND_FMT_S24 },
    { "int16",		GENSIO_SOUND_FMT_S16 },
    { "int8",		GENSIO_SOUND_FMT_S8 },
    { "uint32",		GENSIO_SOUND_FMT_U32 },
    { "uint24",		GENSIO_SOUND_FMT_U24 },
    { "uint16",		GENSIO_SOUND_FMT_U16 },
    { "uint8",		GENSIO_SOUND_FMT_U8 },
    { "doublebe",	GENSIO_SOUND_FMT_DOUBLE_BE },
    { "floatbe",	GENSIO_SOUND_FMT_FLOAT_BE },
    { "int32be",	GENSIO_SOUND_FMT_S32_BE },
    { "int24be",	GENSIO_SOUND_FMT_S24_BE },
    { "int16be",	GENSIO_SOUND_FMT_S16_BE },
    { "uint32be",	GENSIO_SOUND_FMT_U32_BE },
    { "uint24be",	GENSIO_SOUND_FMT_U24_BE },
    { "uint16be",	GENSIO_SOUND_FMT_U16_BE },
    { "doublele",	GENSIO_SOUND_FMT_DOUBLE_LE },
    { "floatle",	GENSIO_SOUND_FMT_FLOAT_LE },
    { "int32le",	GENSIO_SOUND_FMT_S32_LE },
    { "int24le",	GENSIO_SOUND_FMT_S24_LE },
    { "int16le",	GENSIO_SOUND_FMT_S16_LE },
    { "uint32le",	GENSIO_SOUND_FMT_U32_LE },
    { "uint24le",	GENSIO_SOUND_FMT_U24_LE },
    { "uint16le",	GENSIO_SOUND_FMT_U16_LE },
    {}
};
