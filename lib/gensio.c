...
bool
gensio_is_mux(struct gensio *io)
{
    return io->is_mux;
}
...
bool
gensio_acc_is_mux(struct gensio_accepter *accepter)
{
...
struct gensio_def_entry builtin_defaults[] = {
    ...
    { "hangup-when-done", GENSIO_DEFAULT_INT,	.def.intval = -1 },
    { "custspeed",	GENSIO_DEFAULT_BOOL,	.def.intval = 0 },
    { "rs485",		GENSIO_DEFAULT_STR,	.def.strval = NULL },
    { "uucplock",	GENSIO_DEFAULT_BOOL,	.def.intval = 1 },
    { "flock",		GENSIO_DEFAULT_BOOL,	.def.intval = 1 },
    ...
    { "require-password",GENSIO_DEFAULT_BOOL,	.def.intval = false },
    /* For mux */
