...
io1 = alloc_io(o, "mux(mode=server),relpkt(mode=server),msgdelim,serialdev,/dev/ttyPipeA0", do_open = False)
io2 = alloc_io(o, "mux,relpkt,msgdelim,serialdev,/dev/ttyPipeB0", do_open = False)
