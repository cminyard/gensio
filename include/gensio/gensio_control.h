...
#define GENSIO_CONTROL_IN_AGC			58u
#define GENSIO_CONTROL_OUT_AGC			59u
#define GENSIO_CONTROL_IN_GAIN			60u
#define GENSIO_CONTROL_OUT_GAIN			61u
#define GENSIO_CONTROL_FREQUENCY		62u
#define GENSIO_CONTROL_IN_FREQUENCY		63u
#define GENSIO_CONTROL_OUT_FREQUENCY		64u
#define GENSIO_CONTROL_IN_BANDWIDTH		65u
#define GENSIO_CONTROL_OUT_BANDWIDTH		66u
#define GENSIO_CONTROL_IN_CHANNEL		67u
#define GENSIO_CONTROL_OUT_CHANNEL		68u
#define GENSIO_CONTROL_IN_FREQ_ADJ		69u
#define GENSIO_CONTROL_OUT_FREQ_ADJ		70u
