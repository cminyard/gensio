...
#define GENSIO_CONTROL_IN_ANTENNA		45u
#define GENSIO_CONTROL_OUT_ANTENNA		46u
#define GENSIO_CONTROL_IN_AGC			47u
#define GENSIO_CONTROL_OUT_AGC			48u
#define GENSIO_CONTROL_IN_GAIN			49u
#define GENSIO_CONTROL_OUT_GAIN			50u
#define GENSIO_CONTROL_IN_FREQUENCY		51u
#define GENSIO_CONTROL_OUT_FREQUENCY		52u
#define GENSIO_CONTROL_IN_BANDWIDTH		53u
#define GENSIO_CONTROL_OUT_BANDWIDTH		54u
#define GENSIO_CONTROL_IN_CHANNEL		55u
#define GENSIO_CONTROL_OUT_CHANNEL		56u
