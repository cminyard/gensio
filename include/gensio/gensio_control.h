...
#define GENSIO_CONTROL_DRAIN_TIMEOUT		55u

/* SDR and radio settings. */
#define GENSIO_CONTROL_IN_ANTENNA		56u
#define GENSIO_CONTROL_OUT_ANTENNA		57u
#define GENSIO_CONTROL_IN_GAIN			58u
#define GENSIO_CONTROL_OUT_GAIN			59u
#define GENSIO_CONTROL_FREQUENCY		60u
#define GENSIO_CONTROL_IN_FREQUENCY		61u
#define GENSIO_CONTROL_OUT_FREQUENCY		62u
#define GENSIO_CONTROL_IN_BANDWIDTH		63u
#define GENSIO_CONTROL_OUT_BANDWIDTH		64u
#define GENSIO_CONTROL_IN_CHANNEL		65u
#define GENSIO_CONTROL_OUT_CHANNEL		66u
#define GENSIO_CONTROL_IN_FREQ_ADJ		67u
#define GENSIO_CONTROL_OUT_FREQ_ADJ		68u
#define GENSIO_CONTROL_IN_FREQ_CORR		69u
#define GENSIO_CONTROL_OUT_FREQ_CORR		70u
#define GENSIO_CONTROL_IN_IQ_BALANCE		71u
#define GENSIO_CONTROL_OUT_IQ_BALANCE		72u
#define GENSIO_CONTROL_IN_DC_OFFSET		73u
#define GENSIO_CONTROL_OUT_DC_OFFSET		74u

/* Keep the async control numbers in a different range, just to be safe. */
